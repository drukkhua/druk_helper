...
from bot_factory import create_bot_instance, validate_bot_configuration, cleanup_bot_resources
    ...
    async def health_check(self) -> dict:
        ...
        try:
            health_status = {
                ...
                'templates_loaded': len(self.template_manager.templates) if self.template_manager else 0,
