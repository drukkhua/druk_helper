...
class TestStats:
    ...
    def test_log_template_usage_existing_entry(self, stats_manager, temp_stats_file, sample_stats_data):
    ...
    def test_log_template_usage_new_category(self, stats_manager, temp_stats_file, sample_stats_data):
    ...
    def test_get_stats_summary_with_data(self, stats_manager, temp_stats_file, sample_stats_data):
