...
class ErrorHandler:
    ...
    async def _send_user_notification(self, error: Exception, update: Optional[types.Update], user_id: Optional[int]) -> None:
        ...
        try:
            ...
            for arg in args:
                if isinstance(arg, (Message, CallbackQuery)):
                    update = types.Update(message=arg) if isinstance(arg, Message) else types.Update(callback_query=arg)
                    break
