...
from error_monitor import get_health_status, get_error_statistics, generate_error_report
        ...
        try:
            if command == 'status':
                ...
                return {
                    ...
                    'available_commands': ['status', 'reload', 'restart', 'error_report', 'template_stats'],
                    'timestamp': datetime.now().isoformat()
                }
        except Exception as e:
