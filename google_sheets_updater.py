...
class GoogleSheetsUpdater:
    ...
    def get_all_sheets_info(self, sheet_id: str) -> List[Dict]:
    ...
    def download_csv_data(self, sheet_id: str, gid: str) -> Optional[str]:
    ...
    def save_csv_to_data(self, csv_content: str, filename: str) -> bool:
    ...
    def update_templates_from_google_sheets(self, spreadsheet_url: str) -> bool:
        """
        ...
        try:
            ...
            for sheet_info in sheets_info:
                ...
                if normalized_name in self.sheet_mapping:
                    ...
                    csv_content = self.download_csv_data(sheet_id, gid)
                    if csv_content:
                        # Сохраняем в папку data
                        if self.save_csv_to_data(csv_content, filename):
                            updated_count += 1
                        else:
...
def update_templates_from_sheets(spreadsheet_url: str = None) -> bool:
    """
    ...
    return sheets_updater.update_templates_from_google_sheets(spreadsheet_url)


if __name__ == "__main__":
    # Тестирование модуля
    test_url = "https://docs.google.com/spreadsheets/d/1RagVK40gWitjfQE-_wBD8HnSaeDGGMZJ2uWfICLRqFQ/edit?usp=sharing"
    success = update_templates_from_sheets(test_url)
